...
@XmlRootElement(name = "Promotion")// 便是可以被cxf数据封装的对象
public class Promotion implements Serializable {
	...
	public void setTitleImg(String titleImg) {
		if (titleImg.startsWith("http")) {
			...
			this.titleImg = Constants.BOS_MANAGEMENT_HOST + titleImg;
		}
	...
	public String toString() {
		return "Promotion [id=" + id + ", title=" + title + ", titleImg="
				+ titleImg + ", activeScope=" + activeScope + ", startDate="
				+ startDate + ", endDate=" + endDate + ", updateTime="
				+ updateTime + ", updateUnit=" + updateUnit + ", updateUser="
				+ updateUser + ", status=" + status + ", description="
				+ description + "]";
	}
